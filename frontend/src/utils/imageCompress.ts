...
// Una foto moderna (4032×3024, 8-15MB) no cabe en la API tal cual; se
// redimensiona a MAX_COMPRESSED_DIMENSION px y se exporta como JPEG con
// calidad adaptativa (baja hasta que el peso encaja). El resultado queda
// muy por debajo de los 10MB del backend, así la subida no depende del
// tamaño que produzca el móvil.
...
export function needsCompression(sizeBytes: number, limitBytes: number = MAX_COMPRESSED_BYTES): boolean {
